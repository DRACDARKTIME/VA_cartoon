# generacion_cartoon guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `generacion_cartoon/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `generacion_cartoon` folder and use the modules inside your notebooks :
...
```python
from generacion_cartoon.utils.paths import data_dir
data_dir()
```
